...
namespace U_DUTRU
{
    ...
    class DUTRU_20171220 : UDOFormBase
    {
        public DUTRU_20171220()
        {
        }
                ...
                foreach (SAPbouiCOM.Column c in pMatrixItem.Columns)
                {
                    ...
                    else if (pType == 2)
                    {
                        ...
                        if (c.Title == "Chi phí Mua bán" || c.Title == "Chi phí Thuê" || c.Title == "Chi phí Vận hành" || c.Title == "LineId"
                            ...
                            || c.Title == "Business Partner" || c.Title == "Business Partner Name"
                            || c.Title == "SubProject Code" || c.Title == "SubProject Description" || c.Title == "Dự trù tổng LineID")
                        {
                            if (c.Visible == false)
                                c.Visible = true;
                        }
