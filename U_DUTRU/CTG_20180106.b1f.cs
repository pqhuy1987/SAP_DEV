...
namespace U_DUTRU
{
    ...
    class CTG_20180106 : UDOFormBase
    {
        public CTG_20180106()
        {
        }
            ...
            if (pVal.FormMode == 1)
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < Sum_DUTRU.Rows.Count; i++)
                    {
                        ...
                        //CP PRELIM
                        ((SAPbouiCOM.EditText)oMtx.Columns.Item("C_0_15").Cells.Item(i + 1).Specific).Value = r["CP_PRELIM"].ToString();
                        //CP TB
                        ((SAPbouiCOM.EditText)oMtx.Columns.Item("C_0_16").Cells.Item(i + 1).Specific).Value = r["CP_TB"].ToString();
                        //CP Khac
                        ((SAPbouiCOM.EditText)oMtx.Columns.Item("C_0_17").Cells.Item(i + 1).Specific).Value = r["CP_Khac"].ToString();
