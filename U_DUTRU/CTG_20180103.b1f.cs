...
namespace U_DUTRU
{
    ...
    class CTG_20180103 : UDOFormBase
    {
        public CTG_20180103()
        {
        }
        ...
        public override void OnInitializeComponent()
        {
            ...
            this.Button0 = ((SAPbouiCOM.Button)(this.GetItem("bt_dtccm").Specific));
            this.Button0.PressedAfter += new SAPbouiCOM._IButtonEvents_PressedAfterEventHandler(this.Button0_PressedAfter);
            this.Matrix1 = ((SAPbouiCOM.Matrix)(this.GetItem("1_U_G").Specific));
            this.Button1 = ((SAPbouiCOM.Button)(this.GetItem("bt_dteq").Specific));
            this.Button1.PressedAfter += new SAPbouiCOM._IButtonEvents_PressedAfterEventHandler(this.Button1_PressedAfter);
            this.Matrix2 = ((SAPbouiCOM.Matrix)(this.GetItem("3_U_G").Specific));
